  ...
  return (
    <>
      <style>{`
        ...
        .-w .image-1 img {
         ...
         .-w .title {
          grid-column-start: 1;
          grid-column-end: 15;
          grid-row-start: 2;   /* ← was 1, now below the image row */
          align-self: start;
          text-align: center;
          position: relative;
        }
      ...
      <div className="-w" ref={wrapRef}>
        ...
        <h1 className="title -h0 -mid-h2 -m-h3" aria-hidden="true">
...
//         </figure>
//         {/* <span className="line" /> */}
//         <h1 className="title" aria-hidden="true"> {qualification.University} </h1>
//       </div>
//     </>
//   );
// }
